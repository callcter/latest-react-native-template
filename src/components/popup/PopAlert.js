...
class PopAlert extends React.Component {
  ...
  render() {
    ...
    const alertBoxStyle = [Styles.alertBox, {
    ...
    if (this.state.showAlert) {
      return (
        <Animated.View
          style={[Styles.container, { opacity: this.state.animValue, zIndex: this.props.zIndex }]}
        >
...
const mapDispatchToProps = (dispatch) => bindActionCreators({ ...AlertActionCreators }, dispatch);
