...
const Color = {
  ...
  colors: ['#377df6', '#ff6600', '#f3b93c', '#6ecc51', '#d28ae2','#39e4c2',  '#6568ce', '#a88463','#4e4056', '#d3d3d3'],
  pColors: [processColor('#377df6'),processColor('#ff6600'),processColor('#f3b93c'),processColor('#6ecc51'),processColor('#d28ae2'),processColor('#39e4c2'),processColor('#6568ce'),processColor('#a88463'),processColor('#4e4056'),processColor('#d3d3d3')]
}
